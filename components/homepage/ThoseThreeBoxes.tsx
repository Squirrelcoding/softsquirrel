    ...
    <Grid grow>
      ...
      <Grid.Col span={4}>  
        <Card shadow="sm" padding="xl">
          <Card.Section>
            <p className="ml-5 text-3xl font-medium">Our goal</p>
          </Card.Section>
      ...
      <Grid.Col span={4}>
        <Card shadow="sm" padding="xl">
          <Card.Section>
            <h1 className="ml-5 text-3xl font-medium">We are cool 😎</h1>
          </Card.Section>
          <Text weight={500} size="md">
      ...
      <Grid.Col span={4}>
        <Card shadow="sm" padding="xl">
          <Card.Section>
            <h1 className="ml-5 text-3xl font-medium">2022 objectives</h1>
          </Card.Section>
          <Text weight={500} size="md">
